...
const htmls = `
  ...
  const init = {
    ...
    type: '',
    targets: [{value: 'surge-module', label: 'Surge 模块', suffix: '.sgmodule'}, {value: 'stash-stoverride', label: 'Stash 覆写', suffix: '.stoverride'}, {value: 'shadowrocket-module', label: 'Shadowrocket 模块', suffix: '.sgmodule'}, {value: 'loon-plugin', label: 'Loon 插件', suffix: '.plugin'}, {value: 'stash-rule-set', label: '(Stash) 规则集', suffix: '.list' }, {value: 'loon-rule-set', label: '(Loon) 规则集', suffix: '.list' }, {value: 'shadowrocket-rule-set', label: 'Shadowrocket 规则', suffix: '.list' }, {value: 'surge-rule-set', label: '(Surge RULE-SET) 规则集', suffix: '.list' }, {value: 'surge-domain-set', label: '(Surge DOMAIN-SET¹) 域名集  「需配合RULE-SET²使用」', suffix: '.list' }, {value: 'surge-domain-set2', label: '(Surge RULE-SET²) 无法转换为 DOMAIN 类型的剩余规则集', suffix: '.list' }, {value: 'surge-script', label: 'Surge 脚本(兼容)', suffix: '.js'}, {value: 'plain-text', label: '纯文本'}],
    target: '',
    src: '',
    n: '',
    filename: '',
